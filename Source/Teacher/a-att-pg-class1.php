...
<main>
    <div id="card">
        <div id="card-body">
            <div id="permanentBox">
                <div id="imageBox">
                    <img class="card-img-top" src="DepEd_circ.png" alt="Card image cap" id="img">
                </div>
            </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            var defaultImagePath = "DepEd_circ.png";
            var currentImages = [];
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data) {
                                ...
                                $('#img').attr('src', defaultImagePath);  // Clear the image source
                                $('#fname').text('Unknown');
                                $('#lname').text('Unknown');
                            }
                        },
