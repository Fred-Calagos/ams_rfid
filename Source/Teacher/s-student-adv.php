        ...
        <div class="table-responsive">
            ...
            <div class="modal_content_student">
                    ...
                    <hr style="border: 2px solid black; width:100%;">
                        ...
                        <div class="half">
                                <?php
                                    $sql = "SELECT ti.*, adv.t_id AS advId, adv.grade AS gr, adv.section AS sc FROM teacher_info AS ti 
                                            LEFT JOIN teacher AS adv ON ti.t_id = adv.t_id
                                            WHERE t_rfid = '$username'";
                                    $data = mysqli_query($conn, $sql);
                                        while ($advData = mysqli_fetch_array($data)) {
                                            $advId = $advData['advId'];
                                            $grId = $advData['gr'];
                                            $scId = $advData['sc'];
                                        }
                                ...
                                <input type="hidden" name="adviser" id="advisory" value="<?php echo $advId?>">
                                <input type="hidden" name="grade" id="grade" value="<?php echo $grId?>">
                                <input type="hidden" name="section" id="section" value="<?php echo $scId?>">
                        </div>
                        <!-- ENROLLMENT SECTION -->
