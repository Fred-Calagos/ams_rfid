...
<body>
    ...
    <div class="top">
        ...
        <div class="bread">
                ...
                <li class="breadcrumb-item active"><a href="m-teacher.php">Teacher Information</a></li>
                </ol>
            </div>
            <div class="table-responsive">
            <div class="row well">
                <ul>
                    <li><a id="add_teach" class="btn_create1"><i class="fa fa-plus-circle" aria-hidden="true"></i> &nbsp; Add Teacher</a></li>
                </ul>
            </div><br>
