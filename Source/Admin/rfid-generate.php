...
<section class="dashboard">
    ...
    <div class="dash-content">
        ...
        <div class="container">
        <a href="m-rfid.php" class="btn btn-medium btn-info"><i class="fa-solid fa-left-long"></i></a>
        </div>

        <div class="container">
            <form method="post" action="mul-add-rfid.php">

                <table class='table-tr'>
                    <tr>
                        <th colspan="2">Enter how many cards you want to register.</th>
                    </tr>
                    <tr>
                        <td>
