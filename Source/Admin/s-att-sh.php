    ...
    <section class="dashboard">
        ...
        <div class="dash-content">
                ...
                if(isset($_POST['submit2'])) {
                    ...
                    $fetchingStudents = mysqli_query($conn, "SELECT 
                                        ...
                                        LEFT JOIN strands AS st ON ns.strand_id = st.strand_id
                                         ...
                                         GROUP BY ag.student_id, gr.stud_grade, sc.section_name, sy.sy_name, tr.track_name, st.strand_name
            ...
            <div class="printable">
                ...
                <tr>
                <td colspan="2" style="text-align:right;"><label for="">School Name</label></td>
                    <td  colspan="8">
...
if ($student) {
    ...
    <tr>
        ...
        <td colspan="4"style="text-align:right"><label for="">Month of</label></td>
        <?php
    ...
    <tr>
        ...
        <p> please refer to legend number 2. If TRANSFERRED</p>
        <p> IN/OUT, write the name of School.)</p>
        </td>
    </tr>
    <tr>
            <?php
...
?>
            ...
            <div class="printable">
                ...
                <table class="table-container" id="tbl_cont">
                <tr>
                    <td colspan="5"  style="text-align:center;border:none"><img src="../../images/admin/DepEd_circ.png" alt="" srcset="" height="100" width="100"></td>
                    <td colspan="15" style="border:none;text-align:center"><h2>School Form 2 (SF2) Daily Attendance Report of Learners</h2></td>
