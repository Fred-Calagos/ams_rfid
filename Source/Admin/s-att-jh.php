...
do {
    ...
    for ($j = 1; $j <= $totalDaysInMonth; $j++) {
        ...
        $dateOfAttendance = date("$year-m-$dayFormatted", strtotime("$firstDayOfMonth + $j days"));
        echo "Processing Date: $dateOfAttendance<br>";
                ...
                <div class="container">
                    ...
                    <div class="guidelines">
                        ...
                        <tr>
                            ...
                            <tr><td colspan="3" style="word-wrap: break-word; white-space: normal;">4. Every end of the month, the class adviser will submit this form to the office of the principal for recording of summary table into School Form 4. Once signed by the principal, this formlihould be returned to the adviser.</td></tr>
                    ...
                    <div class="codes">
                        ...
                        <ul>
                            <li>(blank) - Present; (x)- Absent; Tardy (half shaded = Upper for Late Comer, Lower for Cutting Classes)</li>
                        </ul>
