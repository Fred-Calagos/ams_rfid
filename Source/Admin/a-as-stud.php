...
$pagi = '';
    ...
    if(isset($_POST["query"]))
        ...
        WHERE arc_stat = 1 AND student_id LIKE '%".$search."%'
    ...
    if(mysqli_num_rows($result) > 0)
        ...
        while($row_morning = mysqli_fetch_array($result))
        {
            ...
            <tr>
                ...
                <td>
                    <a href="s-edit.php?e_id='.$row_morning['id'].'&name='.$row_morning['fname'].'"><i class="fas fa-edit btn_edit1"></i></a>
                    <a href="m-student.php?arc_id='.$row_morning['id'].'"><i class="fas fa-archive btn_create1"></i></a>
