...
<?php 
    ...
    if (time() > $day_out_time) {
        ...
        $query = "SELECT ns.student_id FROM new_students ns 
                LEFT JOIN attendance_gate ag ON ns.student_id = ag.student_id AND ag.att_date = ?
...
.rightImage {
    width: 130px;
    height: 130px; /* Auto height to maintain aspect ratio */
...
<main>
    ...
    function resetCardData() {
        ...
        setTimeout(resetCardData, 3000); // 3 seconds  i want to use resetCard if the   
